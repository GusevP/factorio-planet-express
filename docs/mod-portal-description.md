...
1. A planet's Cargo Landing Pad asks for what it wants — just like vanilla.
2. Planet Express finds another planet with spare stock.
3. It sends one of your ships to carry it over, and to bring back anything the source still needs on the way home.
...
1. Research **Interplanetary Trade Logistics**
2. Open a **Space Platform Hub** → Fleet tab → tick **Enroll this platform in the merchant fleet**
3. Open a planet's **Cargo Landing Pad** → Trade tab → choose what it should import
4. Done — ships start flying. Watch them in the top-left panel, or click it for the full Monitor.
